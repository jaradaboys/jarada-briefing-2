...
alert(`${incoming.length}개의 JARVIS 관찰일지를 불러왔고, 기본값을 업데이트했습니다.`);
  ...
  <div style={styles.sectionHint}>
    구글폼 심화설문과 연계되어 아이별 학부모 기대 방향을 정리하는 영역입니다. 교사는 키워드보다 아래 해석문을 중심으로 아이의 수업 방향을 확인하면 됩니다.
  </div>
...
<section style={{ ...styles.card, marginTop: 24 }}>
  ...
  <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 20 }}>
    <button style={styles.primaryBtn} onClick={deliverMonthlyBriefing}>
      이번달 전달 저장 + 다음달 기본값 업데이트
    </button>

    <button style={styles.secondaryBtn} onClick={saveRecord}>
      기록만 저장
    </button>

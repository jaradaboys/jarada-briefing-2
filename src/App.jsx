...
<p style={{ ...styles.subtitle, maxWidth: 860 }}>
  우리는 아이의 작품과 수업 장면을 넘어, 그 안에 쌓이고 있는 성장의 흐름을 읽어냅니다.
  <br />
  학부모 니즈, JARVIS 누적 기록, 이번달 교사 해석을 연결해 아이의 변화가 다음 성장으로 이어지도록 돕습니다.
</p>
          </div>

          <div style={styles.darkCard}>
          <div style={{ fontWeight: 800, marginBottom: 14 }}>자라다 성장 구조</div>
          <div style={{ display: "grid", gap: 12, lineHeight: 1.65, fontSize: 13 }}>
  <div>
  <strong>1. 성장의 큰 흐름</strong>
<div
  style={{
    marginTop: 8,
    color: "#cbd5e1",
...
>
  <div>건강한 자립</div>
  <div style={{ color: "#94a3b8", lineHeight: 1 }}>↓</div>
  <div>자존감</div>
  <div style={{ color: "#94a3b8", lineHeight: 1 }}>↓</div>
  <div>반복된 자아실현</div>
  <div style={{ color: "#94a3b8", lineHeight: 1 }}>↓</div>
  ...
  <div>
    <strong>2. 나이별 성장과제</strong>
    <div style={{ marginTop: 6, color: "#cbd5e1" }}>
      6–7세: 행동적 자기조절 · 내면적 자기조절
      <br />
      <span style={{ color: "#94a3b8" }}>교실규칙 / 만족지연 / 교사신뢰 / 분리안정</span>
      <br />
      8–11세: 인지적 자기조절 · 사회적 자기조절
      <br />
      <span style={{ color: "#94a3b8" }}>과제설정 / 계획 / 완성 / 의견조율 / 인정받기 / 도구숙달</span>
      <br />
      12–13세: 메타인지적 자기조절 · 정서적 자기경영
      <br />
      <span style={{ color: "#94a3b8" }}>자신의 강점·약점 이해 / 한계넘기 / 내적동기 / 역할과 정체성</span>
    </div>
  </div>

  <div>
    <strong>3. 자기조절 성장 3단계</strong>
    <div style={{ marginTop: 6, color: "#cbd5e1" }}>
      인지: 행동적 → 인지적 → 메타인지적
      <br />
      정서: 내면적 → 사회적 → 정서적 자기경영
